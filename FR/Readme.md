...
A 5-bit loadable Flag Register with asynchronous reset. The Flag Register stores the status flags generated by the Arithmetic Logic Unit (ALU) updates them on the positive edge of the clock when the load signal is asserted.
